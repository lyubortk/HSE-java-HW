...
public class Trie {
    ...
    /**
     * Write trie state as byte sequence.
     * @param out non-null {@link OutputStream} to write trie state to
     */
    ...
    /**
     * Replace current trie with one read from stream. The data
     * should be generated by {@link Trie#serialize} method.
     * @param in non-null {@link InputStream} to read trie state from
     */
